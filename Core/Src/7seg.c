...
//		HAL_GPIO_WritePin(GPIOA, SEG0_Pin|SEG3_Pin|SEG4_Pin|SEG5_Pin|SEG6_Pin, 1);
		break;
	case 2:
...
//		HAL_GPIO_WritePin(GPIOA, SEG0_Pin|SEG3_Pin|SEG4_Pin, 1);
		break;
	case 5:
		HAL_GPIO_WritePin(GPIOA, SEG0_Pin| SEG2_Pin | SEG3_Pin | SEG5_Pin | SEG6_Pin, 0);
//		HAL_GPIO_WritePin(GPIOA, SEG1_Pin|SEG4_Pin, 1);
		break;
	case 6:
